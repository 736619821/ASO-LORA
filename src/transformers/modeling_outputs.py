...
class BaseModelOutputWithPast(ModelOutput):
    ...
    ffn_weights: Optional[Tuple[torch.FloatTensor]] = None
    lastgradient: Optional[torch.FloatTensor] = None
...
class BaseModelOutputWithPastAndCrossAttentions(ModelOutput):
    ...
    attentions: Optional[Tuple[torch.FloatTensor]] = None
    cross_attentions: Optional[Tuple[torch.FloatTensor]] = None
    ffn_weights: torch.FloatTensor = None 
...
class Seq2SeqLMOutput(ModelOutput):
    ...
    encoder_hidden_states: Optional[Tuple[torch.FloatTensor]] = None
    encoder_attentions: Optional[Tuple[torch.FloatTensor]] = None
    encoder_ffn_weights: Optional[torch.FloatTensor] = None
    gradient: Optional[torch.FloatTensor] = None 
